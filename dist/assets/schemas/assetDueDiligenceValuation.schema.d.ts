...
export declare const AssetDueDiligenceValuationSchema: MongooseSchema<AssetDueDiligenceValuation, import("mongoose").Model<AssetDueDiligenceValuation, any, any, any, Document<unknown, any, AssetDueDiligenceValuation, any, {}> & AssetDueDiligenceValuation & Required<{
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, AssetDueDiligenceValuation, Document<unknown, {}, import("mongoose").FlatRecord<AssetDueDiligenceValuation>, {}, import("mongoose").DefaultSchemaOptions> & import("mongoose").FlatRecord<AssetDueDiligenceValuation> & Required<{
    _id: import("mongoose").Types.ObjectId;
}> & {
    __v: number;
}>;
